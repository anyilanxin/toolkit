...
public class BasicActorStressTest {
  ...
  @Benchmark
  @Threads(1)
  public void shouldRunActors1Thread(final BenchmarkContext ctx) throws InterruptedException {
    sendBurst(ctx);
  }

  @Benchmark
  @Threads(2)
  public void shouldRunActors2Threads(final BenchmarkContext ctx) throws InterruptedException {
    sendBurst(ctx);
  }

    private void sendBurst(final BenchmarkContext ctx) throws InterruptedException {
  ...
  static class ClosableActor extends Actor {
      ...
      ClosableActor(final CountDownLatch latch) {
      this.latch = latch;
    }
