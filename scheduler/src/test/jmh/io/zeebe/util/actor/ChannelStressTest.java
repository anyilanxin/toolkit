...
public class ChannelStressTest {
  ...
  @Benchmark
  @Threads(1)
  public void shouldConsumeBurst1Thread(final ThreadContext ctx) {
    sendBurst(ctx);
  }

  @Benchmark
  @Threads(2)
  public void shouldConsumeBurst2Threads(final ThreadContext ctx) {
    sendBurst(ctx);
  }

    private void sendBurst(final ThreadContext ctx) {
