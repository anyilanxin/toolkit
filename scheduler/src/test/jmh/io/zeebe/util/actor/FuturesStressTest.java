...
public class FuturesStressTest {
  ...
  public void ping(final BenchmarkContext ctx) throws InterruptedException {
  ...
  @Benchmark
  @Threads(1)
  public void pingPong(final BenchmarkContext ctx) throws InterruptedException {
  ...
  @Benchmark
  @Threads(1)
  public void getScalability1Threads(final BenchmarkContext ctx) throws InterruptedException {
    ctx.pingActor.ping().join();
  }

  @Benchmark
  @Threads(4)
  public void getScalability4Threads(final BenchmarkContext ctx) throws InterruptedException {
    ctx.pingActor.ping().join();
  }

  @Benchmark
  @Threads(8)
  public void getScalability8Threads(final BenchmarkContext ctx) throws InterruptedException {
    ctx.pingActor.ping().join();
  }
  ...
  static class PingActor extends Actor {
      public ActorFuture<Void> ping(final PongActor pongActor) {
      return actor.call(
          () -> {
            pongActor.pong();
          });
  ...
  static class PongActor extends Actor {
      private final PingActor pingActor;
      private final CountDownLatch latch;

      PongActor(final PingActor pingActor, final CountDownLatch latch) {
